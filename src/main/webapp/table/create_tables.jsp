...
try {
	...
	String q1 = "Create table users(name varchar(100),email varchar(100) primary key, mobileNumber bigint(15), securityQuestion varchar(200), answer varchar(200) , password varchar(100), address varchar(500),city varchar(100), state varchar(100), country varchar(100))";
